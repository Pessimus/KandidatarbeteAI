...
//-----------------------------------------------VARIABLES------------------------------------------------------------\\
	...
	public enum RENDER_OBJECT_ENUM{
		CHARACTER("res/Villager16x16.png"), CHARACTER2("res/female.png"), LAKE("res/lake.png"), STONE("res/stone1.png"),
		...
		THINK_DRINKING("res/drinkingThink.png"), DRINKING("res/drinking.png"), THINK_SOWING("res/sowingThink.png"), SOWING("res/sowing.png"),
		EMPTY("res/empty.png"),
